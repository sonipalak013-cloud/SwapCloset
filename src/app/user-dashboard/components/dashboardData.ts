...
export const SWAP_REQUESTS: SwapRequest[] = [
{
  ...
  sentDaysAgo: 1,
  lastMessage: 'Hi Maya! I love your skirt. Would you be interested in swapping for my Everlane blazer?'
},
{
  id: 'swap-req-002',
  type: 'incoming',
...
{ id: 'act-001', type: 'swap_request', description: 'Priya Sharma sent a swap request for your Silk Midi Skirt', time: '2 hours ago', icon: 'ArrowLeftRight' },
{ id: 'act-002', type: 'listing_view', description: 'Your Chelsea Boots got 8 new views today', time: '4 hours ago', icon: 'Eye' },
{ id: 'act-003', type: 'message', description: 'Zoe Nakamura replied to your swap negotiation', time: '6 hours ago', icon: 'MessageSquare' },
{ id: 'act-004', type: 'swap_request', description: 'Jordan Kim wants to swap for your Chelsea Boots', time: 'Yesterday', icon: 'ArrowLeftRight' },
{ id: 'act-005', type: 'listing_saved', description: 'Someone saved your Vintage Windbreaker', time: 'Yesterday', icon: 'Heart' },
{ id: 'act-006', type: 'swap_completed', description: 'Swap completed with Fatima — Floral Wrap Dress', time: '2 days ago', icon: 'CheckCircle' },
{ id: 'act-007', type: 'listing_view', description: 'Your Silk Midi Skirt reached 47 total views', time: '3 days ago', icon: 'Eye' }];
